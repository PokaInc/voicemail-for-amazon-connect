...
function build() {
  ...
  cp "./$AWS_CONNECT_VM_SERVERLESS/.serverless/cloudformation-template-update-stack.json" "../deployment/aws-connect-vm.json"
  eval "python ./tools/transform.py --template ../deployment/aws-connect-vm.json --save ../deployment/aws-connect-vm.json --zip $AWS_CONNECT_VM_SERVERLESS/aws-connect-vm.zip --jar $AWS_CONNECT_VM_SERVERLESS/aws-connect-vm-java.jar"
